...
import { CATEGORIES_QUERY_KEY } from "@/components/finance/hooks/useCategoryQuery";
...
export function useCategoryMutations() {
  ...
  const updateCategories = useCallback(
    async (updates: Array<{ categoryId: string; patch: CategoryPatch }>) => {
